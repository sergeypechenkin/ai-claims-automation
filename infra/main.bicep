  ...
  "body": [
    ...
    },
    {
      ...
      "facts": [
        ...
        { "title": "Document Type:", "value": "@{coalesce(json(body('Call_function_process_email'))?['DocumentType'], 'N/A')}" },
        { "title": "Claim Reference:", "value": "@{coalesce(json(body('Call_function_process_email'))?['ClaimReference'], 'None')}" },
